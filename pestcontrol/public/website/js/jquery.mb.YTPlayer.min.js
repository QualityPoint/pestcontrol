	...
	(jQuery.mbYTPlayer = {
											...
											? (!(function (r) {
													(e.videoData = {}),
														...
														(e.videoData.description =
															r.description.length < 400
																...
																: r.description.substring(0, 400) +
																  " ..."),
														(e.videoData.thumb_max = r.thumbnails
															.maxres
														...
														(e.videoData.thumb_high = r.thumbnails.high
															...
															: null),
														(e.videoData.thumb_medium = r.thumbnails
															.medium
		...
		enableFilters: function () {
			...
			for (let r in e.filters)
				e.filters[r].value &&
					(t +=
						r.replace("_", "-") + "(" + e.filters[r].value + e.filters[r].unit + ") ");
				...
				(YTPlayer.getState = setInterval(function () {
					...
					if (
						...
						YTPlayer.player.getPlayerState() > 0 &&
							(parseFloat(
								YTPlayer.player.getDuration() - YTPlayer.opt.fadeOnStartTime / 1e3
		...
		(e.mbCookie = {
			set: function (e, r, t, a) {
				...
				var o = new Date(),
					n = "";
				0 < t &&
					(o.setTime(o.getTime() + 864e5 * t), (n = "; expires=" + o.toGMTString())),
